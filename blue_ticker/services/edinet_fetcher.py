...
_STATEMENT_SECTIONS_BY_KEY: dict[str, tuple[tuple[str, ...], tuple[str, ...]]] = {
    ...
    "gp": (_INCOME_STATEMENT_SECTIONS, _INCOME_STATEMENT_FALLBACK_SECTIONS),
    "ie": (_INCOME_STATEMENT_SECTIONS, _INCOME_STATEMENT_FALLBACK_SECTIONS),
    "tax": (_INCOME_STATEMENT_SECTIONS, _INCOME_STATEMENT_FALLBACK_SECTIONS),
    "nr": (_INCOME_STATEMENT_SECTIONS, _INCOME_STATEMENT_FALLBACK_SECTIONS),
