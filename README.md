...
- **フルスタック MCP 機能**: 銘柄検索、財務分析、マクロ分析、有報データ抽出、ウォッチリスト・ポートフォリオ管理など **全11ツール** を提供。AI がツールを組み合わせて分析を実行します。
...
### ポートフォリオを管理する
```bash
mebuki portfolio add 7203 --quantity 100 --cost-price 2500 --broker SBI --account-type NISA
mebuki portfolio list
mebuki portfolio sell 7203 --quantity 50
```
